...
interface ImageAnalyzerIconProps {
    onLaunch: () => void;
}

const ImageAnalyzerIcon: React.FC<ImageAnalyzerIconProps> = ({ onLaunch }) => {
    return (
        <div 
...
export default ImageAnalyzerIcon;